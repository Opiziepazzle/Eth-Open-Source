...
router.post('/resend-verification-email', VerificationController.ReVerifyEmail);
...
router.post('/request-reset-password', VerificationController.RequestResetPassword);
